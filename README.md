...
## كيفية إعداد مشروع TypeScript:
 ...
 اولًا يجب التآكد من وجود بيئة العمل Node.js 
 
 وللتحقق من ذالك سوف نقوم بالذهاب الى الـTerminal الخاص بنا وكتابة الآمر 
...
وفي حال اردنا التأكد من نجاح التحميل نقوم بكتابة الامر التالي :


    tsc -v

*ملاحظه : في حال حدوث مشكلة بجهاز من نوع Mac  او كنت تستخدم نظام linex نقوم بكتابة كلمة sudo قبل الامر 
